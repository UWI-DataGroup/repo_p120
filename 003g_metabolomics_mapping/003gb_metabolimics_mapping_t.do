...
grmap `x' using  "`datapath'/Neighborhoods/San_Juan_Census_Tracts/PR_tracts_coordinates.dta", 
			...
			title(`: variable label `x'' "All" "San Juan, Puerto Rico", color(black) size(3.5))
...
grmap `x' using  "`datapath'/Neighborhoods/San_Juan_Census_Tracts/PR_tracts_coordinates.dta", 
			...
			title(`: variable label `x'' "No Diabetes" "San Juan, Puerto Rico", color(black) size(3.5))
...
grmap `x' using  "`datapath'/Neighborhoods/San_Juan_Census_Tracts/PR_tracts_coordinates.dta", 
			...
			title(`: variable label `x'' "Diabetes" "San Juan, Puerto Rico", color(black) size(3.5))
