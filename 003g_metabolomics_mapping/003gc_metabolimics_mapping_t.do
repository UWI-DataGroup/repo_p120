...
grmap `x' using  "`datapath'/Neighborhoods/BB_Parish/Barbados_Parish_coordinates.dta", 
			...
			legend(pos(2))
			title(`: variable label `x'' "All" "Barbados", color(black) size(3.5))
			
			label(data("`datapath'/Spatial Join/BB_metabolomics_all_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(small) color(gs4))
...
grmap `x' using  "`datapath'/Neighborhoods/BB_Parish/Barbados_Parish_coordinates.dta", 
			...
			legend(region(lcolor(black)))	
			legend(pos(2))
			title(`: variable label `x'' "No Diabetes" "Barbados", color(black) size(3.5))
			
			label(data("`datapath'/Spatial Join/BB_metabolomics_No_DM_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(small) color(gs4))
...
grmap `x' using  "`datapath'/Neighborhoods/BB_Parish/Barbados_Parish_coordinates.dta", 
			...
			legend(region(lcolor(black)))	
			legend(pos(2))
			title(`: variable label `x'' "Diabetes" "Barbados", color(black) size(3.5))
			
			label(data("`datapath'/Spatial Join/BB_metabolomics_DM_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(small) color(gs4))
