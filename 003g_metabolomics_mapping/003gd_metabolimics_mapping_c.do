...
grmap `x' using  "`datapath'/Neighborhoods/USVI_Estates/USVI_Estates_adjusted_coordinates.dta", 
			...
			title("US Virgin Islands", c(black) size(3.5))
			
			label(data("`datapath'/Spatial Join/USVI_metabolomics_all_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(vsmall) color(gs4))
...
grmap `x' using  "`datapath'/Neighborhoods/USVI_Estates/USVI_Estates_adjusted_coordinates.dta", 
			...
			label(data("`datapath'/Spatial Join/USVI_metabolomics_No_DM_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(vsmall) color(gs4))
...
grmap `x' using  "`datapath'/Neighborhoods/USVI_Estates/USVI_Estates_adjusted_coordinates.dta", 
			...
			label(data("`datapath'/Spatial Join/USVI_metabolomics_DM_label.dta")  xcoord(xcoord)  ycoord(ycoord) label(Join_Count) size(vsmall) color(gs4))
